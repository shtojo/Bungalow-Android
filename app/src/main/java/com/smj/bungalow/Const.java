 ...
 * These must be consistent between the client and server code
 */
...
public final class Const {
    ...
    DOORBELL                Doorbell
    FREEZE                  Freezing temperature detected
    APPLICATION_STARTED     Application was started
    ...
    */
    ...
    static final String[] ZONE_TYPE_NAMES = {
            "Unknown",
            "Door",
            "Window",
            "Motion",
